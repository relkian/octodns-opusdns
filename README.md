...
An [octoDNS](https://github.com/octodns/octodns/) provider that targets [OpusDNS](https://developers.opusdns.com/).
...
TODO: OpusDNSProvider does not support dynamic records.
